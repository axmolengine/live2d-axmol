...
elseif(WINDOWS)
  ...
  if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    set_target_properties(Live2DCubismCore
      PROPERTIES
      IMPORTED_LOCATION ${live2d_core_dir}/lib/windows/x86_64/142/Live2DCubismCore_MD.lib
        IMPORTED_LOCATION_DEBUG
          ${live2d_core_dir}/lib/windows/x86_64/142/Live2DCubismCore_${CRT}d.lib
        IMPORTED_LOCATION_RELEASE
          ${live2d_core_dir}/lib/windows/x86_64/142/Live2DCubismCore_MD.lib
    )
  else()
    set_target_properties(Live2DCubismCore
      PROPERTIES
        IMPORTED_LOCATION ${live2d_core_dir}/lib/windows/x86/142/Live2DCubismCore_MD.lib
        IMPORTED_LOCATION_DEBUG
          ${live2d_core_dir}/lib/windows/x86/142/Live2DCubismCore_${CRT}d.lib
        IMPORTED_LOCATION_RELEASE
          ${live2d_core_dir}/lib/windows/x86/142/Live2DCubismCore_MD.lib
    )
  endif()
elseif(APPLE)
  if(IOS)
